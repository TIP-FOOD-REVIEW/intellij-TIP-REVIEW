...
<div class="max-w-md mx-auto p-4">
    ...
    <div class="mt-8">
        <a href="storeDetail?action=sort&order=desc" class="p-2 rounded-full bg-gray-200">음식 목록 전체 보기</a>
    </div>
    ...
    <div class="mt-8">
        ...
        <div>
            <!-- 별점 순 정렬 버튼 -->
            <a href="storeDetail?action=getReviewListByRatingDESC&storeId=1" class="p-2 rounded-full bg-gray-200">낮은 별점 순</a>
            <a href="storeDetail?action=getReviewListByRatingASC&storeId=1" class="p-2 rounded-full bg-gray-200">높은 별점 순</a>
            <!-- 추가적인 정렬 옵션 가능 -->
        </div>
        <div class="grid grid-cols-2 gap-4">
            ...
            %>
            <div class="p-4">
                <img src="img/aa.png" alt="${review.getImage()}" class="h-32 w-full rounded-lg">
                ...
                <div>
                    <p>리뷰어: <%= user.getUsername() %></p>
                    <p>리뷰 내용: <%= review.getContent() %></p>
                </div>
            </div>
            <%
                    }
